...
\colorbox{OliveGreen}{\textcolor{white}{
\begin{tabular*}{7.1in}{l@{\extracolsep{\fill}}r}
    \textbf{\Large Sean Behan} & \href{tel:2899237907}{\textcolor{white}{289-923-7907}}\\
    & \href{mailto:contact@seanbehan.ca}{\textcolor{white}{contact@seanbehan.ca}}\\
    & \href{https://seanbehan.ca}{\textcolor{white}{seanbehan.ca}}
\end{tabular*}
}
}
...
\begin{itemize}
    \item
        \ressubheading{\faIcon{link} \href{https://github.com/codebam/cf-workers-telegram-bot}{CloudFlare Workers Telegram Bot}}{}{Serverless Telegram Bot on CloudFlare Workers}{Feb. 2021}
    \item
        \ressubheading{\faIcon{link} \href{https://github.com/codebam/pastebin-r2}{Pastebin}}{}{A pastebin using Cloudflare R2}{Sept. 2023}
    \item
        \ressubheading{\faIcon{link} \href{https://github.com/codebam/please}{Please}}{}{A command line program that runs commands given by a prompt to llama2}{Oct. 2023}
    \item
        \ressubheading{\faIcon{link} \href{https://github.com/codebam/spottube}{SpotTube}}{}{Web Extension that gets the YouTube link for your current tab}{Feb. 2021}
\end{itemize}
